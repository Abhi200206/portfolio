export const Experience=()=>{
    return (
        <div className="bg-gradient-to-b to-purple-500 from-pink-500 py-[60px] ">
            <div className="">
                <p className="pl-6 pb-4 text-slate-300 font-extrabold text-5xl">Experience: </p>
            </div>
            <div className="flex justify-center">
                <div className="border-white border-[1px] rounded p-4 m-2">
                    <p className=" text-slate-800 font-extrabold text-3xl py-2">Open-Source contributor</p>
